...
pub static GTE_LUT: [Instruction; 0x40] = [
    ...
    /* 0x01 */ instruction!(GteRtps, Cop, interpreter::gte::gte_rtps),
    /* 0x02 */ Instruction::invalid(),
    /* 0x03 */ Instruction::invalid(),
    /* 0x04 */ Instruction::invalid(),
    /* 0x05 */ Instruction::invalid(),
    /* 0x06 */ instruction!(GteNclip, Cop, interpreter::gte::gte_nclip),
    /* 0x07 */ Instruction::invalid(),
    /* 0x08 */ Instruction::invalid(),
    /* 0x09 */ Instruction::invalid(),
    /* 0x0A */ Instruction::invalid(),
    /* 0x0B */ Instruction::invalid(),
    /* 0x0C */ instruction!(GteOp, Cop, interpreter::gte::gte_op),
    /* 0x0D */ Instruction::invalid(),
    /* 0x0E */ Instruction::invalid(),
    /* 0x0F */ Instruction::invalid(),
    /* 0x10 */ instruction!(GteDpcs, Cop, interpreter::gte::gte_dpcs),
    /* 0x11 */ instruction!(GteIntpl, Cop, interpreter::gte::gte_intpl),
    /* 0x12 */ instruction!(GteMvmva, Cop, interpreter::gte::gte_mvmva),
    /* 0x13 */ instruction!(GteNcds, Cop, interpreter::gte::gte_ncds),
    /* 0x14 */ instruction!(GteCdp, Cop, interpreter::gte::gte_cdp),
    /* 0x15 */ Instruction::invalid(),
    /* 0x16 */ instruction!(GteNcdt, Cop, interpreter::gte::gte_ncdt),
    /* 0x17 */ Instruction::invalid(),
    /* 0x18 */ Instruction::invalid(),
    /* 0x19 */ Instruction::invalid(),
    /* 0x1A */ Instruction::invalid(),
    /* 0x1B */ instruction!(GteNccs, Cop, interpreter::gte::gte_nccs),
    /* 0x1C */ instruction!(GteCc, Cop, interpreter::gte::gte_cc),
    /* 0x1D */ Instruction::invalid(),
    /* 0x1E */ instruction!(GteNcs, Cop, interpreter::gte::gte_ncs),
    /* 0x1F */ Instruction::invalid(),
    /* 0x20 */ instruction!(GteNct, Cop, interpreter::gte::gte_nct),
    ...
    /* 0x27 */ Instruction::invalid(),
    /* 0x28 */ instruction!(GteSqr, Cop, interpreter::gte::gte_sqr),
    /* 0x29 */ instruction!(GteDcpl, Cop, interpreter::gte::gte_dcpl),
    /* 0x2A */ instruction!(GteDpct, Cop, interpreter::gte::gte_dpct),
    /* 0x2B */ Instruction::invalid(),
    /* 0x2C */ Instruction::invalid(),
    /* 0x2D */ instruction!(GteAvsz3, Cop, interpreter::gte::gte_avsz3),
    /* 0x2E */ instruction!(GteAvsz4, Cop, interpreter::gte::gte_avsz4),
    /* 0x2F */ Instruction::invalid(),
    /* 0x30 */ instruction!(GteRtpt, Cop, interpreter::gte::gte_rtpt),
    /* 0x31 */ Instruction::invalid(),
    /* 0x32 */ Instruction::invalid(),
    /* 0x33 */ Instruction::invalid(),
    /* 0x34 */ Instruction::invalid(),
    ...
    /* 0x3B */ Instruction::invalid(),
    /* 0x3C */ Instruction::invalid(),
    /* 0x3D */ instruction!(GteGpf, Cop, interpreter::gte::gte_gpf),
    /* 0x3E */ instruction!(GteGpl, Cop, interpreter::gte::gte_gpl),
    /* 0x3F */ instruction!(GteNcct, Cop, interpreter::gte::gte_ncct),
];
...
pub static GTE_DATA_REGISTER_NAME_LUT: [&str; 32] = [
    "v0_xy", "v0_z", "v1_xy", "v1_z", "v2_xy", "v2_z", "rgbc", "otz", "ir0", "ir1", "ir2", "ir3", "sxy0", "sxy1",
    "sxy2", "sxyp", "sz0", "sz1", "sz2", "sz3", "rgb0", "rgb1", "rgb2", "res1", "mac0", "mac1", "mac2", "mac3", "irgb",
    "orgb", "lzcs", "lzcr",
];
